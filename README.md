...
>* Faça o download do app Expo em seu dispositivo móvel;
>* Após baixado e instalado, execute o mesmo;
>* Após realizado os procedimentos descritos em _[Acesse seu o diretório de seu projeto pelo prompt de comando]_, no app Expo selecione a opção _Scan QR Code_;
